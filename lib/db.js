...
function migrate(d) {
  ...
  // Multiple Discord webhooks with per-event routing (v2.0.1). JSON:
  // { hooks:[{id,name,url}], routes:{start:id,...,chat:id} }. Null = fall back to
  // the legacy single discord_webhook + notify_events + discord_relay_chat fields.
