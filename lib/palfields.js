...
const GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "PublicIP", label: "Public IP (for tunnels)", type: "text", default: "", hint: "Address shown to players in the community server browser. Leave blank to auto-detect. Behind a tunnel (e.g. playit.gg), set this to the tunnel's public IP so friends — including console/PS5 — can find and join." },
      { key: "PublicPort", label: "Public port (advertised)", type: "int", default: 8211, hint: "Port advertised to the community browser. Keep it equal to the game port for normal port-forwarding; set it to your tunnel's public port when using a tunnel." },
