...
const ACTIONS = ["start", "stop", "restart", "broadcast", "backup", "status", "kick"];
...
module.exports = {
  ACTIONS, LEGACY_ACTIONS, COMMANDS, MAX_ROLES, MAX_USERS, STATUS_FIELDS,
  normalizeBotConfig, normalizePermissions, normalizeStatusFields, subjects, publicConfig, maskToken, inviteUrl,
